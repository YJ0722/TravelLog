 ...
 */
public class ManualSlideActivity extends ViewGroup {
    ...
    public ManualSlideActivity(Context context) {
        super(context);
        init();
    }

    public ManualSlideActivity(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ManualSlideActivity(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    private void init() {
        //mWallpaper = BitmapFactory.decodeResource(getResources(), R.drawable.expense);// 배경화면 불러오기
        mPaint = new Paint();
