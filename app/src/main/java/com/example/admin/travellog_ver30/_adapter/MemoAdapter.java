...
public class MemoAdapter extends CursorAdapter {
    ...
    public Memo get(int position) {
        ...
        if (cursor.moveToPosition(position)) {
            int memoNo = cursor.getInt(cursor.getColumnIndex("_id"));
            ...
            memoDB = new Memo(travelNo, logNo, memoNo, memoTitle, memoContent, latitude, longitude, date);
        }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_memo_popup, parent, false);
